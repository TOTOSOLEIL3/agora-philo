...
const SUJETS = [
  { s: "Notre avenir dépend-il de la technique ?", n: ["technique", "temps"],
    ...
    faux: ["La technique est toujours néfaste pour l'homme.", "L'avenir est déjà écrit d'avance."],
  ...
  { s: "La science peut-elle satisfaire notre besoin de vérité ?", n: ["science", "verite"],
    ...
    faux: ["La science est inutile.", "La vérité n'existe pas."],
  ...
  { s: "L'État nous doit-il quelque chose ?", n: ["etat", "devoir"],
    ...
    faux: ["L'État n'existe pas vraiment.", "Les citoyens ne doivent rien à l'État."],
  ...
  { s: "Le bonheur est-il affaire de raison ?", n: ["bonheur", "raison"],
    ...
    faux: ["Le bonheur n'existe pas.", "La raison rend toujours malheureux."],
  ...
  { s: "Vouloir la paix, est-ce vouloir la justice ?", n: ["justice", "etat"],
    ...
    faux: ["La guerre est toujours juste.", "La paix est impossible entre les hommes."],
  ...
  { s: "Revient-il à l'État de décider de ce qui est juste ?", n: ["etat", "justice"],
    ...
    faux: ["L'État est toujours juste par nature.", "La justice n'est qu'une opinion."],
  ...
  { s: "Discuter, est-ce renoncer à la violence ?", n: ["langage", "justice"],
    ...
    faux: ["La discussion ne sert à rien.", "La violence est parfois un devoir."],
  ...
  { s: "Sommes-nous responsables de l'avenir ?", n: ["devoir", "temps"],
    ...
    faux: ["L'avenir n'existe pas.", "Le passé nous détermine entièrement."],
  ...
  { s: "Faut-il toujours dire la vérité ?", n: ["verite", "devoir"],
    ...
    faux: ["Mentir est toujours un mal absolu.", "La vérité n'existe pas."],
  ...
  { s: "Être libre, est-ce faire ce que l'on veut ?", n: ["liberte", "devoir"],
    ...
    faux: ["La liberté n'existe pas.", "Faire ce qu'on veut est toujours impossible."],
  ...
  { s: "L'inconscient échappe-t-il à toute connaissance ?", n: ["inconscient", "science"],
    ...
    faux: ["L'inconscient n'existe pas.", "La conscience connaît tout d'elle-même."],
  ...
  { s: "Le temps n'est-il qu'une illusion ?", n: ["temps", "conscience"],
    ...
    faux: ["Le passé n'a jamais existé.", "Le temps est un objet matériel."],
  ...
  { s: "La religion est-elle l'ennemie de la raison ?", n: ["religion", "raison"],
    ...
    faux: ["Dieu existe avec certitude.", "La science a réfuté toute croyance."],
  ...
  { s: "La nature est-elle un modèle pour l'homme ?", n: ["nature", "devoir"],
    ...
    faux: ["La nature n'existe plus.", "L'homme n'a rien de naturel."],
  ...
  { s: "Une œuvre d'art a-t-elle toujours un sens ?", n: ["art", "langage"],
    ...
    faux: ["L'art ne sert strictement à rien.", "Seul le beau a un sens."],
